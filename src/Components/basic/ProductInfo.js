    ...
    render() {
        ...
        return (
            <div className={'descr-block'}>
                ...
                <br/>
                <div className={'item-page-text'}><p>
                    {description}
                    {/*орем ипсум долор сит амет, еос ин омнесяуе вивендум еррорибус, сеа*/}
                    {/*ин*/}
                    ...
                    {/*вис.*/}
                    {/*Ид ест дуис алияуам делицатиссими, лаудем долорум сцаевола но хас.*/}
                </p></div>
            </div>
        );
    }
